...
---
# <a name="use-powershell-tooconfigure-sql-database-auditing-and-threat-detection"></a>Используйте PowerShell tooconfigure базы данных SQL аудита и угрозы определение
...
| [Set-AzureRmSqlDatabaseAuditingPolicy](/powershell/module/azurerm.sql/set-azurermsqldatabaseauditingpolicy) | Задает hello политику аудита для базы данных. |
