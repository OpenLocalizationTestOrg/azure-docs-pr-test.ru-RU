...
---
# <a name="use-powershell-toosync-between-an-azure-sql-database-and-a-sql-server-on-premises-database"></a>Используйте PowerShell toosync между базы данных SQL Azure и локальной базы данных SQL Server

В этом примере PowerShell настраивает toosync синхронизации данных между базы данных SQL Azure и локальной базы данных SQL Server. 
