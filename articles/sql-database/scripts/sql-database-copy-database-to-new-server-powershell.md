...
---
# <a name="use-powershell-toocopy-a-sql-database-tooa-new-server"></a>Используйте PowerShell toocopy новый сервер tooa базы данных SQL

Этот пример сценария PowerShell создает копию существующей базы данных на новом сервере. 

[!INCLUDE [sample-powershell-install](../../../includes/sample-powershell-install-no-ssh.md)]

## <a name="copy-a-database-tooa-new-server"></a>Скопируйте новый сервер базы данных tooa
...
| [New-AzureRmSqlDatabaseCopy](/powershell/module/azurerm.sql/new-azurermsqldatabasecopy) | Создает копию базы данных, которая использует моментальный снимок hello в hello текущее время. |
