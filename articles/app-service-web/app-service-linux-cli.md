...
Используя команды в этой статье, вы сможете создать веб-приложение на платформе Linux с помощью Azure CLI 2.0 и управлять им.
...
## <a name="change-the-custom-docker-container-for-an-existing-web-app-on-linux-app"></a>Изменение пользовательского контейнера Docker для имеющегося веб-приложения в приложении Linux
...
Чтобы создать веб-приложения PHP 5.6 в приложении Linux, выполните следующую команду:
