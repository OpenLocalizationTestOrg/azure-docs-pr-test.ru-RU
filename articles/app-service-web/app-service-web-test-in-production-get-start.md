...
## <a name="route-traffic-segment-to-a-deployment-slot"></a>Маршрутизация сегмента трафика в слот развертывания
...
> [!NOTE]
> В этих инструкциях предполагается, что у вас уже есть [нерабочая область развертывания](web-sites-staged-publishing.md), а также что нужное содержимое уже [развернуто](web-sites-deploy.md) в веб-приложении.
> 
> 
...
## <a name="force-client-requests-to-a-specific-slot"></a>Принудительная отправка клиентских запросов в конкретный слот
...
### <a name="opt-users-in-to-beta-app"></a>Согласие пользователей на использование бета-версии приложения
