...
В этом сценарии вы узнаете, как служба плана и веб-приложения и развертывания с помощью контейнера Docker приложения ASP.NET Core toocreate группу ресурсов приложения Linux.
