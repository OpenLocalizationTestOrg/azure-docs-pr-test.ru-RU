...
При необходимости установите Azure PowerShell с помощью инструкции hello, найденные в hello hello [руководство по Azure PowerShell](/powershell/azure/overview). Кроме того необходимо репозитории tooGitHub ссылку, которая содержит кода веб-приложения hello.
