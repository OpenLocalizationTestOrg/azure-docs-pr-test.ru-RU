...
* [Добавление проверки подлинности в приложение iOS][iOS] (или в приложение для [Windows], приложение [Android], [Xamarin.iOS], [Xamarin.Android], [Xamarin.Forms] или [Cordova]).
