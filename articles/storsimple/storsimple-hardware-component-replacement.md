...
|:--- |:--- |:--- |:--- |
| Корпус |1 |Нет |[Замена шасси hello на устройстве StorSimple](storsimple-chassis-replacement.md) |
...
| Резервный аккумулятор |2 |Да |[Замените hello резервного аккумуляторного модуля на устройстве StorSimple](storsimple-battery-replacement.md) |
...
Проверьте [обратитесь в службу поддержки корпорации Майкрософт](storsimple-contact-microsoft-support.md) tooorder любой из этих запасных частей.
