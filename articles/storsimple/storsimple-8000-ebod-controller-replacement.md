...
2. Go tooyour устройства и перейдите слишком**параметры** > **работоспособности оборудования**и проверьте состояние hello hello Индикатор для hello действующего модуля контроллера EBOD — зеленый и hello Индикатор для hello не удалось Модуль контроллера EBOD — красным.
