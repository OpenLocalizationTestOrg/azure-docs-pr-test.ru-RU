...
## Разработка
### [Отправка push tooAndroid уведомления, использующие GCM](notification-hubs-android-push-notification-google-gcm-get-started.md)
...
### Принудительная toospecific пользователей
...
#### [Регистрация hello текущего пользователя с помощью ASP.NET](notification-hubs-ios-aspnet-register-user-from-backend-to-push-notification.md)
...
## [Примеры кода](https://azure.microsoft.com/en-us/resources/samples/?service=notification-hubs)
