...
1. В колонке **Параметры**, которая отображается под областью **Виртуальная сеть**, щелкните **Выберите виртуальную сеть**. Откроется колонка **Выбрать виртуальную сеть**.  Щелкните **Создать**, чтобы открыть колонку **Создание виртуальной сети**.

   ![Выбор виртуальной сети][2]

1. В колонке **Создание виртуальной сети** введите приведенные ниже значения и нажмите кнопку **Создать**. Колонки **Создать виртуальную сеть** и **Выбрать виртуальную сеть** закроются. В поле **Подсеть** в колонке **Параметры** будет указана выбранная подсеть.
...
1. В колонке **Параметры** в разделе **Общедоступный IP-адрес** щелкните **Choose a public IP address** (Выбрать общедоступный IP-адрес). Откроется колонка **Choose a public IP address** (Выбрать общедоступный IP-адрес). Щелкните **Создать**.

   ![Выбор общедоступного IP-адреса][3]

1. В колонке **Создать общедоступный IP-адрес** примите значение по умолчанию и нажмите кнопку **ОК**. Колонки **Choose public IP address** (Выбрать общедоступный IP-адрес) и **Создать общедоступный IP-адрес** закроются, а в поле **Общедоступный IP-адрес** будет указан выбранный общедоступный IP-адрес.
