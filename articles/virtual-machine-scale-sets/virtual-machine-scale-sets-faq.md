...
Раздел osProfile также используется в [шаблоне быстрого запуска grelayhost.json](https://github.com/ExchMaster/gadgetron/blob/master/Gadgetron/Templates/grelayhost.json).
...
Чтобы сбросить пароль виртуальных машин в масштабируемом наборе, используйте расширения доступа к виртуальной машине. 
...
Дополнительные сведения об изменении количества виртуальных машин в масштабируемом наборе см. в [этой статье](https://msftstack.wordpress.com/2016/05/13/change-the-instance-count-of-an-azure-vm-scale-set/).
