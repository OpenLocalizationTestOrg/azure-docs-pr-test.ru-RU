...
- Масштабируемые наборы, созданные на основе пользовательских образов (образов виртуальных машин, которые вы создаете и передаете самостоятельно), в настоящее время можно масштабировать до 100 виртуальных машин.
