...
# Начало работы
## [Развертывание на портале hello наборе масштабирования](virtual-machine-scale-sets-portal-create.md)
...
## Развернуть
### [Создание с помощью портала hello](virtual-machine-scale-sets-portal-create.md)
...
### [Преобразования масштабирования набор шаблонов toouse управляемого диска](virtual-machine-scale-sets-convert-template-to-md.md)
...
### [Преобразовать диски toomanaged шаблона](virtual-machine-scale-sets-convert-template-to-md.md)
