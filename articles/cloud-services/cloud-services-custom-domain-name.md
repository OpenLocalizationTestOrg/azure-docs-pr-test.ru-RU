...
> [!NOTE]
> Приступите к работе быстрее! Используйте [пошаговое руководство](http://support.microsoft.com/kb/2990804)по Azure. С его помощью вы без труда сможете связать имя личного домена и защитить обмен данными (SSL) с облачными службами Azure или веб-сайтами Azure.
> 
> 
...
1. Чтобы найти доменное имя **.cloudapp.net** , назначенное для вашей облачной службы, используйте один из этих методов.
   ...
   * Войдите на [классический портал Azure], выберите облачную службу и щелкните **Панель мониторинга**. Затем найдите **URL-адрес сайта** в разделе **Сводка**.
...
1. Чтобы получить IP-адрес для своей облачной службы, используйте один из следующих способов.
   ...
   * Войдите на [классический портал Azure], выберите облачную службу и щелкните **Панель мониторинга**. Затем найдите **Общедоступный виртуальный IP-адрес** в разделе **Сводка**.
...
В этом примере показано создание записи А для корневого домена. Если вы хотите создать запись с подстановочными знаками, чтобы охватить все поддомены, введите__*__в качестве поддомена.
