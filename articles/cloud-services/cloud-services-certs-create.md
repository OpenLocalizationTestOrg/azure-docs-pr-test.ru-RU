...
Сертификаты службы можно передать на классический портал Azure с помощью этого портала или классической модели развертывания. Эти сертификаты связаны с конкретной облачной службой. Они назначаются для развертывания в файле определения службы.
