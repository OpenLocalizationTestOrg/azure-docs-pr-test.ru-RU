...
* На классическом портале Azure щелкните развертывание нужной облачной службы и выберите **Панель мониторинга** в правом нижнем углу страницы (в разделе **сводки**). Имейте в виду, что на этой панели отсутствует метка "Свойства".
