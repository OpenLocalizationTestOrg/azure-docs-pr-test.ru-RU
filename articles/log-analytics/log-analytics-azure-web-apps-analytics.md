...
Аналитику веб-приложений Azure (предварительная версия) можно использовать для углубленного анализа данных [веб-приложений Azure](../app-service-web/app-service-web-overview.md) при сборе разных метрик ресурсов веб-приложений Azure. Это решение позволяет анализировать и искать данные метрик ресурсов веб-приложений.
