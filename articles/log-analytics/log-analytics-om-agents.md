...
5. После успешного прохождения проверки подлинности на странице **Operations Management Suite Onboarding Wizard: Select Workspace** (Мастер адаптации Operations Management Suite: выбор рабочей области) вам будет предложено выбрать рабочую область OMS.  При наличии нескольких рабочих областей выберите в раскрывающемся списке рабочую область, которую необходимо зарегистрировать в группе управления Operations Manager, и нажмите кнопку **Далее**.
...
* **Microsoft.SystemCenter.Advisor.MPUpdate** : обновляет базовые пакеты управления OMS. По умолчанию выполняется каждые 12 часов.
...
1. Войдите в свою подписку OMS и создайте рабочую область в [Microsoft Operations Management Suite](http://oms.microsoft.com/).
...
1. На портале OMS щелкните плитку **Параметры**.
...
4. Обратите внимание на значение **Идентификатор рабочей области** в левой части страницы "Параметры".  Его нужно будет проверить на соответствие группе управления Operations Manager.  
