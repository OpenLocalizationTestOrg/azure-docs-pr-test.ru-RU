...
1. **Вопрос.** Поддерживает ли действие копирования обновление существующих записей?
    ...
    **Ответ.** Нет.
2. **Вопрос:** как работает при повторной попытке Копировать в базе данных Azure Cosmos приходится иметь дело с уже скопированы записей?
...
3. **Вопрос:** поддерживает фабрики данных [диапазон или секционирование данных на основе хэша](../documentdb/documentdb-partition-data.md)?

    **Ответ.** Нет.
4. **Вопрос:** можно указать несколько коллекций Azure Cosmos DB для таблицы?
