...
## [Использовать API Azure AD Graph hello](active-directory-b2c-devquickstarts-graph-dotnet.md)
...
## [Настройка пользовательского интерфейса hello](active-directory-b2c-reference-ui-customization.md)
...
## [Использовать hello reporting API](active-directory-b2c-reference-usage-reporting-api.md)
