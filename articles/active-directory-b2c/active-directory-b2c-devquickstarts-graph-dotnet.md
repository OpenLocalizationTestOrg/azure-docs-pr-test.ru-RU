...
---
# <a name="azure-ad-b2c-use-the-graph-api"></a>Azure AD B2C: использование API Graph
...
После создания клиента B2C необходимо зарегистрировать в нем приложение на [портале Azure](https://portal.azure.com).

> [!IMPORTANT]
> Чтобы использовать API Graph с клиентом B2C, необходимо зарегистрировать выделенное приложение с помощью универсальной колонки *Регистрация приложений* на портале Azure, а **не** с помощью колонки *Приложения* Azure AD B2C. Вам не удастся повторно использовать уже существующие приложения B2C, зарегистрированные в колонке *приложений* Azure AD B2C.
...
6. В колонке "Параметры" щелкните **Ключи** и добавьте новый ключ (также известный как секрет клиента). Также скопируйте его для использования в одном из следующих разделов.
...
1. В колонке "Регистрация приложений" на портале Azure выберите приложение.
2. В колонке "Параметры" щелкните **Необходимые разрешения**.
3. В колонке "Необходимые разрешения" щелкните **Windows Azure Active Directory**.
4. В колонке "Разрешить доступ" выберите разрешение **Чтение и запись данных каталога** из списка **разрешений приложений** и нажмите кнопку **Сохранить**.
5. Наконец, в колонке "Необходимые разрешения" нажмите кнопку **Предоставить разрешения**.
...
Для начала скачайте и установите [помощник по входу в Microsoft Online Services](http://go.microsoft.com/fwlink/?LinkID=286152). Затем скачайте и установите [64-разрядный модуль Azure Active Directory для Windows PowerShell](http://go.microsoft.com/fwlink/p/?linkid=236297).
