...
При вызове графического Runbook и Runbook рабочего процесса PowerShell с помощью встроенного выполнения просто используйте имя необходимого Runbook.  При вызове дочернего модуля runbook PowerShell, необходимо перед его имя с *.\\*  для указания, что сценарий находится в локальном каталоге. 
