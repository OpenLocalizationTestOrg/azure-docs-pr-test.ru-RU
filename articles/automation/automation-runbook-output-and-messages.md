...
5. В разделе "Подробные записи в журнале" колонки "Ведение журналов и трассировка" щелкните **Включить**, чтобы включить подробное ведение журналов. Затем в колонке "Трассировка уровня действия" измените уровень трассировки с **базовой** на **подробную**, так как вам требуется именно такая трассировка.<br>
