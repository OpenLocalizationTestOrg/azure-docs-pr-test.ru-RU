...
#### [Используйте представление Hive hello](hdinsight-hadoop-use-hive-ambari-view.md)
...
#### [Использование hello средства HDInsight для Visual Studio](hdinsight-hadoop-use-hive-visual-studio.md)
#### [Использование удаленного рабочего стола](hdinsight-hadoop-use-hive-remote-desktop.md)
#### [Используйте консоль запросов hello](hdinsight-hadoop-use-hive-query-console.md)
...
### [Выполнение примеров MapReduce hello](hdinsight-hadoop-run-samples-linux.md)
...
#### [Использовать hello .NET SDK](hdinsight-hadoop-use-pig-dotnet-sdk.md)
...
#### [Хранилище Озера tooData записи](hdinsight-storm-write-data-lake-store.md)
...
### [Использование средства HDInsight toocreate Spark приложений](hdinsight-apache-spark-eclipse-tool-plugin.md)
### [Использование средства HDInsight toodebug Spark приложений удаленно через SSH](hdinsight-apache-spark-intellij-tool-debug-remotely-through-ssh.md)
...
### [Подключение Excel tooHadoop](hdinsight-connect-excel-hive-odbc-driver.md)
### [Подключение с использованием драйвера Hive JDBC hello](hdinsight-connect-hive-jdbc-driver.md)
...
### [Подключение к HDInsight tooyour в локальной сети](connect-on-premises-network.md)
...
#### [Использование REST tooinstall приложений](https://msdn.microsoft.com/library/mt706515.aspx)
#### [Публикация приложений HDInsight tooAzure Marketplace](hdinsight-apps-publish-applications.md)
## Безопасность
...
### [Ограничить доступ toodata](hdinsight-storage-sharedaccesssignature-permissions.md)
## Управление
...
#### [Используйте cURL и hello Azure REST API](hdinsight-hadoop-create-linux-clusters-curl-rest.md)
#### [Использовать hello .NET SDK](hdinsight-hadoop-create-linux-clusters-dotnet-sdk.md)
#### [Использовать hello Azure CLI](hdinsight-hadoop-create-linux-clusters-azure-cli.md)
#### [Использовать hello портал Azure](hdinsight-hadoop-create-linux-clusters-portal.md)
...
#### [Использовать hello Azure CLI](hdinsight-administer-use-command-line.md)
### [Управление кластерами с помощью Ambari web hello пользовательского интерфейса](hdinsight-hadoop-manage-ambari.md)
...
### [Средства разработки tooResource диспетчера миграции](hdinsight-hadoop-development-using-azure-resource-manager.md)
### [Доступность и надежность](hdinsight-high-availability-linux.md)
### [Обновление версии toonewer кластера HDInsight](hdinsight-upgrade-cluster.md)
...
#### [Использование представления Ambari toodebug Tez заданий](hdinsight-debug-ambari-tez-view.md)
...
## Кластеры Windows
### [Перенос кластеров tooLinux кластеры Windows](hdinsight-migrate-from-windows-to-linux.md)
### [Перенос кластеров tooLinux решения .NET](hdinsight-hadoop-migrate-dotnet-to-linux.md)
...
### [Используйте графы крупномасштабных tooprocess Giraph](hdinsight-hadoop-giraph-install.md)
...
### [Использование приложений Java toobuild Maven](hdinsight-hbase-build-java-maven.md)
### [Использовать hello задания Tez toodebug Tez пользовательского интерфейса](hdinsight-debug-tez-ui.md)
...
### [Мониторинг кластеров с помощью Ambari API hello](hdinsight-monitor-use-ambari-api.md)

# Ресурсы
## [Стратегия развития Azure](https://azure.microsoft.com/roadmap/?category=intelligence-analytics)
## [Получить справку по форум hello](https://social.msdn.microsoft.com/forums/azure/en-US/home?forum=hdinsight)
