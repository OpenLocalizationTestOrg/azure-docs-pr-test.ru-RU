...
1.  Убедитесь, что установлена последняя версия Eclipse Neon и Buildship (версия 1.0.17 или более поздняя).
    -   Чтобы проверить версии установленных компонентов, в Eclipse Neon выберите **Help** > **Installation Details** (Справка > Сведения об установке).
    ...
    -   Чтобы проверить и установить обновления для Eclipse Neon, выберите **Help** > **Check for Updates** (Справка > Проверить обновления).
...
Если подключаемый модуль Service Fabric уже установлен, убедитесь, что вы используете последнюю версию. Чтобы проверить наличие доступных обновлений, выберите **Help** > **Installation Details** (Справка > Сведения об установке). В списке установленных подключаемых модулей выберите Service Fabric и щелкните **Update** (Обновить). После этого будут установлены доступные обновления.
...
1.  В Eclipse Neon выберите **File** > **New** > **Other** (Файл > Создать > Другое). Выберите **Service Fabric Project** (Проект Service Fabric) и нажмите кнопку **Next** (Далее).
...
Чтобы обновить приложение с помощью Eclipse Neon, можно создать профиль повторяющейся конфигурации запуска. Затем вы сможете использовать его для обновления приложения.
