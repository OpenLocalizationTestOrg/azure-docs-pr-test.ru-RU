...
> [!WARNING]
> Если вы [выполнили миграцию](site-recovery-migrate-to-azure.md#what-do-we-mean-by-migration), переместили виртуальную машину в другую группу ресурсов или удалили виртуальную машину Azure, то после этого невозможно восстановить размещение.
...
Помните, что репликация осуществляется только через VPN типа "сеть — сеть" или частный пиринг сети ExpressRoute. Убедитесь, что этот сетевой канал обеспечивает достаточную пропускную способность.
