...
---
# <a name="step-5-prepare-azure-resources-for-physical-server-replication-tooazure"></a>Шаг 5: Подготовка ресурсов Azure для репликации tooAzure физического сервера


Используйте инструкции hello в этой статье tooprepare Azure ресурсы, чтобы можно было реплицировать tooAzure локальных серверов, с помощью hello [Azure Site Recovery](site-recovery-overview.md) службы.
...
Убедитесь, что вы прочитали hello [необходимых компонентов](physical-walkthrough-prerequisites.md).
...
- Проверьте областей hello поддерживается для восстановления сайта в разделе **географическая доступность** в [сведения о ценах Azure Site Recovery](https://azure.microsoft.com/pricing/details/site-recovery/).
...
- Site Recovery реплицирует tooAzure серверах в локальном хранилище. Виртуальные машины Azure создаются из хранилища hello после отработки отказа.
