---
title: "Документация по диспетчеру трафика - учебники, справочник по API aaaAzure | Документы Microsoft"
description: "Узнайте, как toomanage входящего трафика для оптимальной производительности приложения. Документации показано, как toodistribute трафика tooAzure или внешние конечные точки службы."
...
Узнайте, как toouse диспетчера трафика tooroute входящего трафика для оптимальной производительности и надежности. Учебники, ссылки на API и другую документацию показывают, как toomanage трафика tooAzure или внешние конечные точки службы.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Подробнее о диспетчере трафика</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Видеотека по диспетчеру трафика Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Начало работы с диспетчером трафика Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Начать управление с помощью портала Azure hello конечные точки диспетчера трафика</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="https://msdn.microsoft.com/library/mt163667.aspx">справочник по API REST</a></p>
                    </div>
                </div>
            </div>
        </div>
