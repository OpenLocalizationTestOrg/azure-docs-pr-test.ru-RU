...
В этой статье перечислены hello стран и регионов, используемые hello **географическая** метод маршрутизации в диспетчере трафика Azure трафика. Эти сведения можно также получить программно, вызвав [REST API диспетчера трафика Azure](https://docs.microsoft.com/rest/api/trafficmanager/). 
...
- World (мир)
    ...
    - GEO-NA (Северная Америка, Центральная Америка, Карибские о-ва)
        ...
        - VC (Сент-Винсент и Гренадины hello)
