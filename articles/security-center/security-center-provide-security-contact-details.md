...
2. Откроется колонка **Укажите сведения о контактных лицах по вопросам безопасности**. Выберите подписку Azure для предоставления контактных данных.
   ![Указать сведения о контактных лицах по вопросам безопасности][2]
