...
Microsoft времени использовал модели угроз для своих продуктов и сделал общедоступные процесс моделирования угроз hello компании. Hello опыт компании показано, что hello моделирования имеет непредвиденный преимущества за пределами hello немедленно понять типы угроз, которые являются hello большинство спецификаций. Например он также создает лазейку открытую дискуссию с другими пользователями за пределами команды разработчиков hello, что может стать причиной toonew идеи и усовершенствования в продукте hello.
...
Hello разделах будут рассматриваться стандартные компоненты, которые обычно находятся в этих зон.
...
Корпорация Майкрософт использует framework hello, описанные выше моделирования для Azure IoT toodo угроз. В следующем разделе hello таким образом мы используем конкретный пример hello Azure IoT Эталонная архитектура toodemonstrate способ идентификации toothink о IoT и как tooaddress hello угроз моделирования угроз. В нашем сценарии мы выявили четыре основных области, на которых следует сосредоточиться:
...
toolearn Дополнительные сведения о защите вашего решения IoT. в разделе [защите развертывания IoT][lnk-security-deployment].
