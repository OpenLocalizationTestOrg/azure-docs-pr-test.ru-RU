...
Пошаговое руководство по языку SQL-запросов API DocumentDB см. в статье [SQL-запросы для API DocumentDB в Azure Cosmos DB](documentdb-sql-query.md).  
...
3.  Ссылаться на псевдоним, который представляет выражение пути к документу.  
     ...
     **Соглашения о синтаксисе**  
     ...
     В таблице ниже описываются соглашения, используемые для описания синтаксиса в справочнике по языку запросов API DocumentDB.  
...
####  <a name="bk_array_contains"></a> ARRAY_CONTAINS  
 Возвращает логическое значение, указывающее, содержит ли массив указанное значение.  
