...
---
# <a name="get-an-azure-cosmos-db-connection-string-for-mongodb-apps-using-hello-azure-cli"></a>Получить строку подключения базы данных Azure Cosmos для MongoDB приложений, использующих hello Azure CLI

В этом примере возвращает строку подключения базы данных Azure Cosmos для MongoDB приложений, использующих hello Azure CLI. 
...
| [az cosmosdb list-connection-strings](https://docs.microsoft.com/cli/azure/cosmosdb#list-connection-strings) | Возвращает строку hello подключения для учетной записи hello.|
