...
---
# <a name="replicate-an-azure-cosmos-db-database-account-in-multiple-regions-and-configure-failover-priorities-using-hello-azure-cli"></a>Реплицировать базу данных Azure Cosmos учетную запись базы данных в нескольких регионах и настроить с помощью Azure CLI hello приоритетов отработки отказа

Этот пример реплицирует любые виды Azure Cosmos DB учетная запись базы данных в нескольких регионах и настраивает приоритетов отработки отказа с помощью Azure CLI hello.
