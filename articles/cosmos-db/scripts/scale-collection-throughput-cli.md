...
---
# <a name="scale-azure-cosmos-db-container-throughput-using-hello-azure-cli"></a>Масштаб пропускной способности контейнера Azure Cosmos DB с помощью hello Azure CLI
