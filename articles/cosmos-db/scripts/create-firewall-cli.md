...
---
# <a name="azure-cosmos-db-create-a-firewall-using-hello-azure-cli"></a>Azure Cosmos DB: Создание брандмауэра с помощью hello Azure CLI
...
| [az cosmosdb update](https://docs.microsoft.com/cli/azure/cosmosdb#update) | Обновляет параметры брандмауэра Azure CosmosDB tooinclude учетной записи. |
