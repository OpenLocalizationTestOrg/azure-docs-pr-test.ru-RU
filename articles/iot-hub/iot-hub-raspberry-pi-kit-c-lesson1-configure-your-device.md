...
* USB-SD адаптер или мини SD карты tooburn hello ОС образ на карту microSD, hello.
...
2. Установите карту microSD toohello Raspbian.
   ...
   6. Вставьте карту microSD hello в вашей Pi.
