...
| ------------ | -------- |
| **positive** | Центр Интернета вещей создает отзыв на сообщение, только если сообщение, отправляемое из облака на устройство, достигает состояния **Completed** (Завершено). |
| **negative** | Центр Интернета вещей создает отзыв на сообщение, только если сообщение, отправляемое из облака на устройство, достигает состояния **Deadlettered** (Не доставлено). |
