...
* [Сообщаемые свойства][lnk-twins] предназначены для передачи сведений о состоянии устройства, таких как доступные возможности, условия и состояние длительных рабочих процессов. Например, настройка и обновления программного обеспечения.
...
Иногда приложению требуется отправка сведений (телеметрии временных рядов или оповещений), которые также должны быть доступны в двойнике устройства. В этом сценарии можно выбрать один из следующих вариантов.
