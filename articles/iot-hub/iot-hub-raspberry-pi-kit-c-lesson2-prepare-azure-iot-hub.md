...
При использовании центра IoT tooyour Pi tooadd hello Azure CLI hello службы создает ключ для tooauthenticate Pi со службой hello. Если у вас возникнут проблемы, искать решения на hello [страницу устранения неполадок](iot-hub-raspberry-pi-kit-c-troubleshooting.md).
...
[Создание приложения Azure функции и центра IoT tooprocess и хранилище учетной записи хранилища Azure сообщения](iot-hub-raspberry-pi-kit-c-lesson3-deploy-resource-manager-template.md).
