...
Кроме того, вы можете использовать шлюз IoT Edge для подключения имитируемых устройств к вашему Центру Интернета вещей.
