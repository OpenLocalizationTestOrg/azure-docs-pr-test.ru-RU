...
## Проверьте IP tooand потоков из виртуальной Машины
...
## [Анализ нарушений toofind захват пакетов](network-watcher-deep-packet-inspection.md)
## [Используйте пакет отслеживания toodo упреждающего мониторинга сети с помощью функций Azure](network-watcher-alert-triggered-packet-capture.md)
