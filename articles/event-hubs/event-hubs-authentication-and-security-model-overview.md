...
При создании пространства имен концентраторов событий служба создает 256-битный ключ SAS с именем **RootManageSharedAccessKey**. Этот ключ дает пространству имен право на отправку, прослушивание и управление. Кроме того, можно создать дополнительные ключи. Рекомендуется создать ключ, дающий разрешения на отправку в конкретный концентратор событий. Далее в этом разделе предполагается, что вы дали ключу имя **EventHubSendKey**.
