...
-   Не используйте параметр `single-transaction` в mysqldump при выполнении дампа очень больших баз данных. Дамп большого количества таблиц в одной транзакции приводит к использованию дополнительных ресурсов хранилища и памяти во время восстановления, а также может привести к задержкам производительности или ограничениям ресурсов.
-   При выполнении дампа баз данных используйте операции вставки нескольких значений при загрузке с помощью SQL, чтобы свести к минимуму затраты на выполнение инструкции. При использовании файлов дампа, созданных служебной программой mysqldump, операции вставки нескольких значений включены по умолчанию. 
...
Чтобы подключиться, найдите сведения о подключении на странице свойств в базе данных Azure для MySQL.
![Поиск сведений о подключении на портале Azure](./media/concepts-migrate-dump-restore/1_server-properties-name-login.png)
