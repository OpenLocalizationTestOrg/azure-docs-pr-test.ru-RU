...
* **Интеграция с Visual Studio.** Выделенные инструменты в Visual Studio упрощают работу по созданию, развертыванию, отладке приложений API и управлению ими. Дополнительную информацию см. в статье о [ выпуске пакета Azure SDK 2.8.1 для .NET](https://azure.microsoft.com/blog/announcing-azure-sdk-2-8-1-for-net/).
...
## <a name="whats-the-difference-between-api-apps-and-azure-api-management"></a>Разница между приложениями API и службой управления API Azure
...
Чтобы задать вопросы о приложениях API, начните беседу на [форуме по приложениям API](https://social.msdn.microsoft.com/Forums/en-US/home?forum=AzureAPIApps). 
