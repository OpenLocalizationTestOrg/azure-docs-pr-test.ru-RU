...
1. Выберите только что созданный **ServiceBusQueueTrigger** и щелкните **Параметры приложения-функции** в правом верхнем углу. Выберите **Перейти к параметрам службы приложений > Параметры > Параметры приложения**.
