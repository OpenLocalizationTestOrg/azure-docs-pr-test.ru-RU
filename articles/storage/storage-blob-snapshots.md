...
Если для учетной записи хранения, в которой хранится большой двоичный объект, включено шифрование службы хранилища (SSE), то все неактивные моментальные снимки этого большого двоичного объекта также будут шифроваться.
...
* Дополнительные сведения о работе с моментальными снимками диска виртуальной машины см. в статье [Архивация неуправляемых дисков виртуальной машины Azure с помощью добавочных моментальных снимков](storage-incremental-snapshots.md).
