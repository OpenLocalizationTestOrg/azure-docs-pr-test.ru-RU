...
* Просмотрите дополнительные toolearn функция руководства о дополнительных параметрах для хранения данных в Azure.
  * [Начало работы с хранилищем таблиц Azure, с помощью .NET](storage-dotnet-how-to-use-tables.md) toostore структурированные данные.
  * [Начало работы с хранилищем больших двоичных объектов Azure с помощью .NET](storage-dotnet-how-to-use-blobs.md) toostore неструктурированных данных.
