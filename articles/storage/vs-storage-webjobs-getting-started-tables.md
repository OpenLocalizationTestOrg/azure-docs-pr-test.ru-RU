...
Дополнительные сведения о том, как toouse hello **CloudTable** см. в разделе [приступить к работе с хранилищем таблиц Azure, с помощью .NET](storage-dotnet-how-to-use-tables.md).
...
Сведения о обработки таблицы toohandle запуска, очереди сообщений и для веб-задания сценариев SDK не обработки, содержатся определенного tootable [Приступая к работе с хранилищем очередей Azure и Visual Studio подключенные службы (для проектов веб-задания) ](vs-storage-webjobs-getting-started-queues.md).
