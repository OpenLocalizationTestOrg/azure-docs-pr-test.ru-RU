...
* [рекомендации по ее устранению]
  ...
  * [Устранение неполадок с хранилищем файлов Azure в Windows](../files/storage-troubleshoot-windows-file-connection-problems.md)   
  * [Устранение неполадок с хранилищем файлов Azure в Linux](../files/storage-troubleshoot-linux-file-connection-problems.md)
* [приложения]
...
Можно выбрать, какие часовых метрик требуется toodisplay в hello [портал Azure](https://portal.azure.com) и настройка правил, которые уведомления администраторов по электронной почте каждый раз, когда почасовые метрики превышает определенный порог. Дополнительные сведения см. в статье [Создание оповещений для служб Azure с помощью портала Azure](/azure/monitoring-and-diagnostics/monitoring-overview-alerts.md). 
