...
* После отработки отказа существующие конечные точки службы хранилища для больших двоичных объектов, таблиц, очередей и файлов остаются прежними. При этом потребуется обновить запись DNS для переключения с основного региона на дополнительный.
