...
Сведения об использовании службы хранилища Azure — устойчивой, доступной и масштабируемой службы облачного хранения. В руководствах, справочниках по API и другой документации показано, как настроить хранилище больших двоичных объектов, таблиц, очередей, файлов и дисков виртуальной машины и управлять им.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>См. дополнительные сведения о хранилище Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Видеотека материалов по хранилищу Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Создание учетной записи хранения</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/cli/azure/storage">Интерфейс командной строки Azure</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/dotnet/api/microsoft.windowsazure.storage.datamovement">.NET: перемещение данных</a></p>
                        <p><a href="https://msdn.microsoft.com/library/azure/mt347887.aspx">.NET: большие двоичные объекты, очереди, таблицы и файлы</a></p>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/storageservices/azure-storage-services-rest-api-reference">BLOB-объекты, очереди, таблицы и файлы</a></p>
                        <p><a href="/rest/api/storagerp">Поставщик ресурсов</a></p>
                        <p><a href="/rest/api/storageimportexport">Импорт и экспорт</a></p>
                        <p><a href="/rest/api/storageservices">Azure Storage Services REST API Reference</a> (Справочник по REST API службы хранилища Azure)</p>
                   </div>
                </div>
            </div>
        </div>
