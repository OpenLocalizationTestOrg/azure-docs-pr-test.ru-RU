...
Также можно использовать один файл tooanother AzCopy toocopy или toocopy большого двоичного объекта tooa файла, и наоборот. В разделе [перенесите данные с помощью служебной программы командной строки AzCopy hello](../common/storage-use-azcopy.md?toc=%2fazure%2fstorage%2ffiles%2ftoc.json).
...
Кроме того, можно ссылаться слишком[хранилища Azure File статьи по устранению неполадок](storage-troubleshoot-windows-file-connection-problems.md) для начала до конца рекомендации по устранению неполадок.
