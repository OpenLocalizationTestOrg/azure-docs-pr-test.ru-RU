...
3. **Копировать hello UNC-путь в hello портал Azure в области «Подключиться» hello**: как toofind эти сведения можно найти подробное описание [здесь](storage-how-to-use-files-portal.md#connect-to-file-share).
