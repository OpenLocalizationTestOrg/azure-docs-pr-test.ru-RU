...
> [!NOTE]
> Хранилище файлов Azure поддерживает только локально избыточное хранилище (LRS) и геоизбыточное хранилище (GRS). Сведения о хранилище файлов Azure см. в [обзоре хранилища файлов Azure](storage-files-introduction.md).
>
