...
Эта служба принимает аргументы, 4 и вычисляет прогнозы ETS hello.
...
Существует несколько способов использования службы hello в автоматическом режиме (пример приложения — [здесь](http://microsoftazuremachinelearning.azurewebsites.net/etsForecasting.aspx)).
...
В службах машинного обучения Azure создан пустой эксперимент. Загружен образец входных данных с заранее заданной схемой данных. Схема данных связанного toohello [выполнение скрипта R] [ execute-r-script] модуль, который приводит к возникновению ошибки hello ETS прогнозирование модели с помощью функции «ets» и «прогноз» из кода R. 
