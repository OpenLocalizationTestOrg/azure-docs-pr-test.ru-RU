...
* Если вы используете новую веб-службу, см. статью [Переобучение новой веб-службы с помощью командлетов управления PowerShell машинного обучения](machine-learning-retrain-new-web-service-using-powershell.md).
...
Если вы работаете с уже существующей веб-службой на основе Azure Resource Manager, см. статью [Retrain an existing Predictive Web service](machine-learning-retrain-existing-resource-manager-based-web-service.md) (Переобучение существующей прогнозной веб-службы).
...
Если вы развернули прогнозную веб-службу с помощью команды **Deploy Web Service [Classic]** (Развернуть веб-службу [классическую]), см. статью [Переобучение классической веб-службы](machine-learning-retrain-a-classic-web-service.md).

Если вы развернули прогнозную веб-службу с помощью команды **Deploy Web Service [New]** (Развернуть веб-службу [новую]), см. статью [Переобучение новой веб-службы с помощью командлетов управления PowerShell машинного обучения](machine-learning-retrain-new-web-service-using-powershell.md).
