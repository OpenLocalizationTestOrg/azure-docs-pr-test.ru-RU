...
> Тем не менее в примере эксперимента [Telco Customer Churn](http://gallery.cortanaintelligence.com/Experiment/31c19425ee874f628c847f7e2d93e383) из [коллекции Cortana Intelligence](http://gallery.cortanaintelligence.com/) для построения аналогичной модели используются общедоступные данные.
> 
