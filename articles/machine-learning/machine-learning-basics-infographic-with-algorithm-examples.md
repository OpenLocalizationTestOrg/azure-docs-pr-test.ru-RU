...
* Более глубокое обсуждение различных типов алгоритмов машинного обучения, их использования и выбора алгоритма, подходящего для решения, см. в статье [Выбор алгоритмов машинного обучения Microsoft Azure](machine-learning-algorithm-choice.md).
...
* Общие сведения о коллекции Cortana Intelligence и множестве доступных ресурсов, созданных участниками сообщества, см. в статье [Поиск ресурсов в коллекции Cortana Intelligence и обмен ими](machine-learning-gallery-how-to-use-contribute-publish.md).
