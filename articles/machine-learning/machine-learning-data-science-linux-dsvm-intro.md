...
Также доступен образ [Ubuntu](machine-learning-data-science-dsvm-ubuntu-intro.md), содержащий множество инструментов, аналогичных входящим в образ CentOS, а также платформы глубокого обучения. Также доступен образ [Windows](machine-learning-data-science-provision-vm.md).
