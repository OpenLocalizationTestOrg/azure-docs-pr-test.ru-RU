...
4. Отправьте соответствующее событие. Раздел с подробными сведениями о всех типах событий см. ниже (пример события щелчка) <script> if (typeof AzureMLRecommendationsEvent=="undefined") {         
