...
При создании рабочей области в службе машинного обучения Azure по умолчанию в нее добавляется ряд примеров экспериментов и наборов данных. Многие из этих примеров наборов данных используются в примерах моделей в [коллекции Azure Cortana Intelligence](http://gallery.cortanaintelligence.com/). Остальные примеры включают примеры различных типов данных, обычно используемых в машинном обучении.
...
Остальная часть этих примеров наборов данных доступна в рабочей области в разделе **Saved Datasets** (Сохраненные наборы данных) на палитре модуля слева от холста эксперимента, когда вы откроете или создадите эксперимент в Студии машинного обучения.
...
<tr ID=bill-gates-rgb-image>
  ...
  <td valign=top>
Общедоступный файл изображения, преобразованный в данные в формате CSV.<p> </p>Код для преобразования изображения приводится на странице со сведениями о модели <strong>Color quantization using K-Means clustering</strong> (Квантование цветов с использованием кластеризации методом K-средних).
  </td>
</tr>
