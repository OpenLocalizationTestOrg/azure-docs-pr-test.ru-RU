...
** Распечатки путь к файлам модели для использования в записной книжке потребления. ** Для использования и оценка независимый набор данных, необходимо скопировать и вставить эти имена файлов в «блокноте потребления».
