---
title: "Документация по машинному обучению Azure. Руководства и справочник по API | Документация Майкрософт"
...
Узнайте, как специалисты по обработке и анализу данных и разработчики могут встраивать в приложения прогнозную аналитику с помощью машинного обучения. В руководствах, видеороликах и примерах моделей описывается создание и развертывание моделей машинного обучения.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Сведения о машинном обучении Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Видеотека машинного обучения Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Начало работы с обработкой и анализом данных</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Начало создания эксперимента машинного обучения Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Языки</h3>
                        <p><a href="https://msdn.microsoft.com/library/azure/dn905974.aspx">Справочник по алгоритмам и модулям</a></p>
                   </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/machinelearning">Справочник по REST API</a></p>
                        <p><a href="/azure/machine-learning/machine-learning-web-service-error-codes">Коды ошибок веб-службы</a></p>
                    </div>
                </div>
            </div>
        </div>
