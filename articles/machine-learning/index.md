---
title: "aaaAzure документации обучения машины - учебники, справочник по API | Документы Microsoft"
...
Узнайте, как специалисты по анализу данных и разработчикам использовать машинное обучение tooembed прогнозной аналитики в приложения. Учебники, видео и моделей в примере показывается, как toobuild и развертывания моделей машинного обучения.
