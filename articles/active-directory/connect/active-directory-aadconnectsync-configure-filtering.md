...
4. Найдите правило с именем **Out to AAD — User Join** (Из внешней среды в AD — присоединение пользователя) и щелкните **Изменить**.
...
При синхронизации нескольких лесов AD можно настроить фильтрацию по группам, указав отдельные группы для каждого соединителя AD. Если нужно синхронизировать пользователя в одном лесу AD и у этого пользователя есть несколько соответствующих объектов администратора внешней безопасности в других лесах AD, необходимо убедиться, что на объект пользователя и все соответствующие объекты администратора внешней безопасности распространяется фильтрация на основе групп. Если один или несколько объектов администратора внешней безопасности исключаются из фильтрации на основе групп, объект пользователя не будет синхронизирован с Azure AD.
