...
1. Чтобы найти пользователей с состоянием ошибки в определенной группе, откройте колонку этой группы. Если есть пользователи с состоянием ошибки, в разделе **Лицензии** появится уведомление.
...
2. Чтобы открыть список всех пользователей с состоянием, описанным выше, щелкните уведомление. Для просмотра дополнительных сведений можно щелкнуть отдельного пользователя.
...
3. Чтобы найти все группы, в которых есть по крайней мере одна ошибка, в колонке **Azure Active Directory** выберите **Лицензии**, а затем — **Обзор**. Если есть группы, требующие внимания, выводится информационное поле.
...
4. Щелкните это поле, чтобы просмотреть список всех групп с ошибками. Чтобы получить дополнительные сведения, можно щелкнуть отдельную группу.
...
Ниже описываются все возможные проблемы и способы их устранения.
