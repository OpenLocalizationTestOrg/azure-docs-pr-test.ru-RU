...
<p>Все отчеты, за исключением отчета "Операции входа после нескольких сбоев", также содержат сведения о подозрительных <i>федеративных</i> операциях входа в упомянутые выше службы независимо от поставщика федерации. </p>
...
Этот отчет содержит сведения об операциях входа для *всех* приложений, к которым имеет доступ ваш каталог, включая предварительно интегрированные приложения Майкрософт.
...
#### <a name="sign-in-events-included-in-the-user-activity-report"></a>События входа, включенные в отчет о действиях пользователей
...
> Примечание. Чтобы отчет содержал меньше ненужной информации, в нем не отображены операции входа, которые выполняет [помощник по входу в Microsoft Online Services](http://community.office365.com/en-us/w/sso/534.aspx).
> 
> 

## <a name="things-to-consider-if-you-suspect-security-breach"></a>Полезные действия в случае подозрения о нарушении безопасности
...
2. На странице «Отчеты» выберите отчет, который нужно просмотреть или скачать.
   ...
   > [!NOTE]
   > При первом использовании функции отчетности Azure Active Directory вы получите сообщение с предложением подтвердить согласие на использование. Если вы согласны, щелкните значок с флажком, чтобы продолжить.
   > 
   > 
