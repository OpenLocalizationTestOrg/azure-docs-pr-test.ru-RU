...
- подписка Azure AD;
- серверное приложение JIRA, установленное на 64-разрядной версии сервера Windows (в локальной среде или облачной инфраструктуре IaaS);
...
4. В поле поиска введите **JIRA SAML SSO by Microsoft**.
...
5. На панели результатов выберите **JIRA SAML SSO by Microsoft** и нажмите кнопку **Добавить**, чтобы добавить это приложение.
...
Чтобы установить эту связь, назначьте **имя пользователя** в Azure AD в качестве значения **имени пользователя** в JIRA SAML SSO by Microsoft.
...
3. **[Создание тестового пользователя JIRA SAML SSO by Microsoft](#creating-a-jira-saml-sso-by-microsoft-test-user)** требуется для того, чтобы в JIRA SAML SSO by Microsoft существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
4. Для создания URL-адреса **метаданных** выполните следующие действия.
    ...
    г) Теперь перейдите к странице свойств **JIRA SAML SSO by Microsoft** и скопируйте **идентификатор приложения** с помощью кнопки **Копировать**, а затем вставьте его в Блокнот.
...
6. Обратитесь к [корпорации Майкрософт](mailto:waadpartners@microsoft.com), предоставив следующие данные подключаемого модуля JIRA:
...
7. В другом окне веб-браузера войдите в свой экземпляр JIRA в качестве администратора.
