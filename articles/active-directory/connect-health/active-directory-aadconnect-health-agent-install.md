...
6. На панели действий выберите действие **Изменить свойства службы федерации**.
7. В диалоговом окне "Свойства службы федерации" откройте вкладку **События** .
8. Установите флажки для **успешных и неудачных событий аудита** и нажмите кнопку **ОК**. Этот параметр должен быть включен по умолчанию.
9. Откройте окно PowerShell и выполните следующую команду: ```Set-AdfsProperties -AuditLevel Verbose```.
