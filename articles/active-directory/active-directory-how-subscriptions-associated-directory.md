...
1. Войдите в [Центр управления учетной записью Azure](https://account.windowsazure.com/Home/Index) с помощью данных администратора учетной записи подписки, права на владение которой необходимо передать.
