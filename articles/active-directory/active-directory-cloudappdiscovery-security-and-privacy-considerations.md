...
Корпорация Майкрософт следует строгим нормативным требованиям и правилам безопасности — от надежных методов разработки программного обеспечения до эксплуатации служб.  
...
Агент Cloud App Discovery Endpoint Agent используется для сбора данных об обнаружении приложений от компьютеров, которыми управляет ИТ-подразделение.  
Собранные данные безопасно отправляются по зашифрованному каналу в службу Cloud App Discovery Azure AD.  
Затем данные Cloud App Discovery для организации отображаются на портале Azure. 
...
После подключения к веб-приложению агент собирает данные, приведенные в списке ниже. Собираются только данные тех приложений, обнаружение которых настроено администратором.  
...
При первой установке на компьютер агент сохраняет его доверенный сертификат, который затем используется для безопасного подключения к службе Cloud App Discovery.  
Через это безопасное подключение агент периодически получает конфигурацию политики из службы Cloud App Discovery.  
