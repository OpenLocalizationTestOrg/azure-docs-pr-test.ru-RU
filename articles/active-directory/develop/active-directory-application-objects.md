...
Объект субъекта-службы определяет политику и разрешения для использования приложения в определенном клиенте. Это основа для создания субъекта безопасности, используемого для представления приложения во время выполнения. Схема для свойств объекта субъекта-службы определяется в [сущности ServicePrincipal][AAD-Graph-Sp-Entity] Azure AD Graph. 
