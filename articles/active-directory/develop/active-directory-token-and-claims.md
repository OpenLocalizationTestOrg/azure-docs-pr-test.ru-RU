...
> [!TIP]
> В целях обучения попробуйте изучить утверждения в примере маркера идентификации, вставив его в [calebb.net](http://jwt.calebb.net).
> 
> 
...
| Authentication Instant |Фиксирует дату и время выполнения сеанса проверки подлинности. <br><br> **Пример значения SAML**: <br> `<AuthnStatement AuthnInstant="2011-12-29T05:35:22.000Z">` | |
...
| `ver` |Версия |Обеспечивает хранение номера версии токена. <br><br> **Пример значения JWT**: <br> `"ver": "1.0"` |
