...
> [!IMPORTANT]
> Для управления службой Azure AD мы рекомендуем использовать [Центр администрирования Azure AD](https://aad.portal.azure.com) на портале Azure, а не классический портал Azure, который упоминается в этой статье. Сведения о назначении ролей администратора в центре администрирования Azure AD см. в руководстве по [самостоятельному лицензированию и лицензированию пользователей в Azure AD](active-directory-licensing-get-started-azure-portal.md).
