...
Приобретите лицензии, которые уже включают многофакторную идентификацию Azure, например Azure Active Directory Premium (P1 или P2), Enterprise Mobility Suite + Security (E3 или E5), и назначьте их пользователям в Azure Active Directory. 
