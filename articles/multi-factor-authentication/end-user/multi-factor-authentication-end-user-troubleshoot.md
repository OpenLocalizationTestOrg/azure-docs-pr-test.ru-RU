...
Корпорация Майкрософт предлагает двухфакторную проверку, но ваша организация решает, использовать ли эту функцию. От этого нельзя отказаться, если ваш ИТ-отдел требует ее от вас, также как нельзя отказаться от использования пароля для защиты учетной записи. 
...
Если вы не видите ссылку **Использовать другой вариант проверки**, это означает, что вы не настроили альтернативные методы во время регистрации для двухфакторной проверки подлинности. Обратитесь в свой ИТ-отдел за помощью по входу в учетную запись. После входа в систему [измените свои параметры](multi-factor-authentication-end-user-manage-settings.md), добавив дополнительные методы проверки для следующего раза. 

Если вы видите ссылку **Использовать другой вариант проверки**, но не имеете доступа к альтернативным методам, обратитесь в ИТ-отдел за помощью по входу в учетную запись. 

## <a name="i-lost-my-phone-or-got-a-new-number"></a>Телефон потерялся или получен новый номер
Есть два способа вернуться в свою учетную запись. 1) Выполните вход с использованием дополнительного номера телефона для проверки подлинности, если вы его указывали. 2) Обратитесь в ИТ-отдел, чтобы сбросить настройки.

Если вы потеряли телефон или его у вас украли, мы также рекомендуем попросить ИТ-отдел сбросить пароли приложений и очистить все сохраненные устройства. 
...
Если вы не настраивали другой способ, обратитесь в ИТ-отдел и попросите его удалить настройки. При очередном входе вам будет предложено [настроить многофакторную проверку подлинности](multi-factor-authentication-end-user-first-time.md) еще раз.
...
Если вы выполнили эти шаги по устранению неполадок, но проблемы по-прежнему возникают, обратитесь в свой ИТ-отдел. Скорее всего, они смогут вам помочь.
