...
Если вы видите hello **использовать другой способ проверки** связь, но нет доступа tooyour альтернативные методы, обратитесь в службу входа в учетную запись tooyour помощь tooget отдел ИТ. 
...
Если вы настроили несколько вариантов проверки, включая номер телефона получателя или приложения проверки подлинности на другом устройстве, можно использовать один из них toosign в.
...
Существует несколько причин, почему может повторите toosign в, но не получает текст hello или телефонного звонка. Если успешно получен тексты или телефонные звонки tooyour phone в прошлом hello, то это, скорее всего, проблемы с поставщиком phone hello, не вашей учетной записи. Убедитесь, что у вас есть сигнал хорошо ячейки, что если вы пытаетесь tooreceive текстовое сообщение убедитесь, что вы являетесь может toorecieve текстовых сообщений. Попросите friend toocall или текст вас в качестве теста. 
