...
Когда ИТ-отделу потребуется запустить двухфакторную проверку, вы увидите экран с надписью **Администратор потребовал настроить дополнительную проверку безопасности для этой учетной записи**:
