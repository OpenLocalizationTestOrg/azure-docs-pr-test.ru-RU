...
> [!NOTE]
> Для повышения производительности и масштабируемости рабочих нагрузок HPC используйте [ресурсоемкие экземпляры Azure, например серию H](../virtual-machines/windows/sizes-hpc.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json). Эти экземпляры также поддерживают параллельные MPI-приложения, для которых требуется сеть приложения с низкими показателями задержки и высокой пропускной способностью. Кроме того, доступны виртуальные машины [серии N](../virtual-machines/windows/sizes-gpu.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) с графическими процессорами NVIDIA. С помощью этих ВМ можно еще больше расширить возможности использования Azure для решения вычислительных и визуализационных задач.  
> 
> 
