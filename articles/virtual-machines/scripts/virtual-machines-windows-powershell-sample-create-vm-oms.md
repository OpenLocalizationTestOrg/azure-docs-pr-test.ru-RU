...
Этот скрипт создает виртуальную машину Azure, устанавливает агент Operations Management Suite (OMS) hello и регистрирует hello системы с помощью рабочей области OMS. После выполнения сценария hello, будут отображаться в консоли OMS hello hello виртуальной машины. Кроме того необходимо tooupdate hello OMS ключ рабочей области идентификатора и рабочей области.
