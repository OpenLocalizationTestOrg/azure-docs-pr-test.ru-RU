...
Этот сценарий создает виртуальную машину Azure с операционной системой Ubuntu. После выполнения сценария hello, доступ к виртуальной машине hello через SSH.
