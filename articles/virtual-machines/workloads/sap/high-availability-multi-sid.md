...
В сентябре 2016 г. корпорация Майкрософт выпустила функцию, которая дает возможность управлять несколькими виртуальными IP-адресами с помощью [внутренней подсистемы балансировки нагрузки Azure][load-balancer-multivip-overview]. Эта функция уже существует в hello Azure внешней подсистемы балансировки нагрузки.
...
> [!NOTE]
> Эта функция доступна только в модели развертывания диспетчера ресурсов Azure hello.
...
4. [Установите экземпляр базы данных hello][sap-ha-guide-9.2].  
 На этом шаге в выделенном кластере WSFC устанавливается СУБД.

5. [Установка второго узла кластера hello][sap-ha-guide-9.3].  
