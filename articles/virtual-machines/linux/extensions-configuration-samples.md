...
> * [PowerShell — шаблон](../windows/extensions-configuration-samples.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)
> * [CLI — шаблон](../windows/extensions-configuration-samples.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
> 
> 
...
об этих расширениях нажмите здесь toolearn: [Обзор расширений ВМ Azure.](../windows/extensions-features.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)

toolearn больше о разработке Шаблоны расширения щелкните здесь: [шаблоны разработки расширения.](../windows/extensions-authoring-templates.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)

В этой статье перечислены конфигурации ожидаемого значения для некоторых hello расширения Linux.
...
Далее в статье hello предоставляет примеры конфигураций для расширения ВМ Linux.
...
Обновленная схема см. в разделе toohello [VMAccessForLinux документации](https://github.com/Azure/azure-linux-extensions/tree/master/VMAccess)
...
Обновленная схема см. в разделе toohello [OSPatching документации](https://github.com/Azure/azure-linux-extensions/tree/master/OSPatching)
...
Обновленная схема см. в разделе toohello [документации расширения Docker](https://github.com/Azure/azure-docker-extension/blob/master/README.md#1-configuration-schema)
