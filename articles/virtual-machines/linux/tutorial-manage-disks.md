...
Добавьте в файл */etc/fstab* строку следующего вида. Также обратите внимание на то, что ограничения записи можно отключить с помощью *barrier=0*. Это может повысить производительность диска. 
