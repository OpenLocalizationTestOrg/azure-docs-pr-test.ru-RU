...
При разработке инфраструктуры приложения, спланируйте toouse уровней приложения hello. Группа виртуальных машин, обслуживающих hello же цели в наборах tooavailability, такие как набор доступности для виртуальных машин переднего плана под управлением nginx или Apache. Создайте отдельную группу доступности для интерфейсных виртуальных машин MongoDB или MySQL. Задача Hello — tooensure, что группа доступности защищен каждого компонента приложения и по крайней мере один раз экземпляр всегда будет работать.
