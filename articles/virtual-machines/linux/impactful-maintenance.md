...
---
# <a name="vm-restarting-maintenance"></a>Обслуживание виртуальных машин с перезапуском
...
### <a name="single-instance-vms-vs-availability-set-or-vm-scale-set"></a>Сравнение одноэкземплярных виртуальных машин с группой доступности и масштабируемым набором
...
Дополнительные сведения о настройке виртуальных машин высокой доступности см. в разделе [ *управлять доступностью виртуальных машин Windows hello*](manage-availability.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
...
### <a name="view-hello-maintenance-window-in-hello-portal"></a>Окно обслуживания hello представления на портале hello 
