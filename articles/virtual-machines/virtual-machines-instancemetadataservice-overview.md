...
- Дополнительные сведения об API-интерфейсе [scheduledevents](virtual-machines-scheduled-events.md) **в общедоступной предварительной версии**, предоставляемом службой метаданных экземпляров.
