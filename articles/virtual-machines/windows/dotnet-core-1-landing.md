...
---
# <a name="automating-application-deployments-toowindows-virtual-machines"></a>Автоматизация развертывания приложения tooWindows виртуальные машины
...
шаблон диспетчера ресурсов хранилища музыка Hello можно найти здесь, [музыка магазина Windows шаблона](https://github.com/Microsoft/dotnet-core-sample-templates/tree/master/dotnet-core-music-windows)
...
| ADMINPASSWORD |Пароль, используемый для hello виртуальной машине Azure и базы данных SQL. |
...
[Шаг 1. Архитектура приложений с использованием шаблонов Azure Resource Manager](dotnet-core-2-architecture.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)
