---
title: "Расширение виртуальной Машины aaaAzureLogCollector | Документы Microsoft"
description: "Описывает hello расширения AzureLogCollector виртуальной Машины, которое собирает все файлы журнала hello и переводит их в одном месте в хранилище Azure."
