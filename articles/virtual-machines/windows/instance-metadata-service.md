...
---
# <a name="azure-instance-metadata-service-for-windows-vms"></a>Служба метаданных экземпляров Azure для виртуальных машин Windows
...
platformUpdateDomain |  [Домен обновления](manage-availability.md) hello в запущенной виртуальной Машине
platformFaultDomain | [Домен сбоя](manage-availability.md) hello в запущенной виртуальной Машине
...
- Дополнительные сведения о hello [запланированные события](scheduled-events.md) API **в общедоступной предварительной версии** предоставляемые hello метаданные экземпляра службы.
