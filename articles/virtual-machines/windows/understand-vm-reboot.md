---
title: "aaaUnderstand перезагрузки системы для виртуальной Машины Windows Azure | Документы Microsoft"
description: "Список событий hello, может привести к tooreboot виртуальной Машины Windows hello"
