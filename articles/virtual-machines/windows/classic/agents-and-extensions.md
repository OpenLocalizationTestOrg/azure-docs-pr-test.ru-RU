---
title: "aaaWindow ВМ агент и расширения в Azure | Документы Microsoft"
description: "Обзор hello агент и расширения, и как tooinstall hello агента, с помощью hello классической модели развертывания на виртуальных машинах Windows."
...
ms.openlocfilehash: 9e5eade7d289267c0932fc98b410b511bd5d7bb4
ms.sourcegitcommit: 523283cc1b3c37c428e77850964dc1c33742c5f0
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 10/06/2017
---
# <a name="about-hello-virtual-machine-agent-and-extensions-for-windows-vms"></a>Об агенте виртуальной машины hello и расширения для виртуальных машин Windows
