...
## [Использование проверки подлинности AAD tooaccess API](media-services-use-aad-auth-to-access-ams-api.md)
### [Использование проверки подлинности AAD toomanage портала](media-services-portal-get-started-with-aad.md)
...
### [Используйте CLI toocreate и настройки приложения в AAD](media-services-cli-create-and-configure-aad-app.md)
### [Используйте PowerShell toocreate и настройки приложения в AAD](media-services-powershell-create-and-configure-aad-app.md)
...
#### [Использовать MES tooauto-формирования лестницу скоростью](media-services-autogen-bitrate-ladder-with-mes.md)
...
##### [Как toogenerate эскизы с помощью Media Encoder стандартный в .NET Framework](media-services-dotnet-generate-thumbnail-with-mes.md)
...
### [Настройка защиты содержимого портала hello](media-services-portal-protect-content.md)
### [Настройка чистого ключа AES-128 для потока](media-services-protect-with-aes128.md)
### [Использовать REST tooencrypt контента с шифрованием хранилища](media-services-rest-storage-encryption.md)
...
### [С помощью toodeliver партнеров Widevine лицензирует tooMedia служб](media-services-licenses-partner-integration.md)
#### [Использование Axinom tooMedia лицензии Widevine toodeliver служб](media-services-axinom-integration.md)
#### [Использование castLabs tooMedia лицензии Widevine toodeliver служб](media-services-castlabs-integration.md)
...
### [Анализ мультимедийного содержимого с помощью портала hello](media-services-portal-analyze.md)
...
### [Вставка рекламы на стороне клиента hello](media-services-inserting-ads-on-client-side.md)
