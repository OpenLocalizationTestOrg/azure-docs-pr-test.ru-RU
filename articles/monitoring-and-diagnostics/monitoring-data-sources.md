...
Через hello Azure платформы, мы, включают данные в одном месте с конвейером монитора Azure hello вместе мониторинга, но практически подтверждаю, что сейчас не все данные наблюдения в этом конвейере еще. В этой статье мы будут использованы Помесячные hello различными способами, можно программно обращаться к данным мониторинга из служб Azure.
...
| Журналы службы приложений | События | Службы приложений | <ul><li>**Хранилище файлов, таблиц или BLOB-объектов:** [диагностика веб-приложений](../app-service-web/web-sites-enable-diagnostic-log.md).</li></ul> |
...
- Дополнительные сведения о [hello журнал действий Azure](monitoring-overview-activity-logs.md)
