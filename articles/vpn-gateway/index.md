---
title: "aaaAzure документация по шлюзу VPN - учебники, справочник по API | Документы Microsoft"
description: "Узнайте, как toomanage шлюзы виртуальной частной сети (VPN) tooconfigure трафик между виртуальными сетями облачной и локальной или облака виртуальных сетей."
...
Узнайте, как tooconfigure виртуальной частной сети шлюза VPN. Документации показано, как toosend сетевой трафик между виртуальными сетями Azure и расположения в локальной или другой Azure виртуальных сетей (Vnet).
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Планирование работы с VPN-шлюзом</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Приступая к созданию соединения сайт сайт с помощью hello портал Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Приступая к созданию соединения точка сеть с помощью портала Azure hello</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Приступая к созданию подключения виртуальной сети для виртуальной сети с помощью hello портал Azure</h3>
                    </div>
                </div>
            </div>
        </div>
