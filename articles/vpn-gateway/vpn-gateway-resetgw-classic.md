...
Чтобы сбросить шлюз, используйте команду [az network vnet-gateway reset](https://docs.microsoft.com/cli/azure/network/vnet-gateway#reset). В следующем примере выполняется сброс шлюза виртуальной сети с именем VNet5GW в группе ресурсов TestRG5:
