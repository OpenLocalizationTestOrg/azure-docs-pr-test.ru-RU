...
Существуют и другие способы toolist hello содержимого контейнера BLOB-объектов. Дополнительные сведения см. в разделе [Приступая к работе с хранилищем BLOB-объектов Azure с помощью .NET](../storage/blobs/storage-dotnet-how-to-use-blobs.md#list-the-blobs-in-a-container).
...
Существуют другие способы toosave большие двоичные объекты как файлы. Дополнительные сведения см. в разделе [Приступая к работе с хранилищем BLOB-объектов Azure с помощью .NET](../storage/blobs/storage-dotnet-how-to-use-blobs.md#download-blobs).
