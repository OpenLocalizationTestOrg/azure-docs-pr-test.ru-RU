        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Библиотека видео по приложениям логики</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Начало создания нового приложения логики, подключающего службы SaaS</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Начало создания нового приложения логики с помощью шаблона</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Схемы</h3>
                        <p><a href="/azure/logic-apps/logic-apps-workflow-definition-language">Язык определения рабочего процесса</a></p>
                        <p><a href="/azure/logic-apps/logic-apps-workflow-actions-triggers">Действия и триггеры рабочего процесса</a></p>
                   </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/logic/">справочник по API REST</a></p>
                    </div>
                </div>
            </div>
        </div>
