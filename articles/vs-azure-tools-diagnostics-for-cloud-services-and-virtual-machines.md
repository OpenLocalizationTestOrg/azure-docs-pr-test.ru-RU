...
### <a name="to-enable-diagnostics-in-azure-virtual-machines"></a>Включение диагностики для виртуальных машин Azure
...
5. Время от времени удаляйте данные из учетной записи хранения, чтобы снизить общие затраты на хранение. Удалять данные не обязательно.
