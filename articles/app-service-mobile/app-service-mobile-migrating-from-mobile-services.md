...
Большинство параметров перенесенной мобильной службы доступны в разделе «Параметры приложения».  Вы можете получить список параметров приложения на [портал Azure].
...
Вы можете управлять своим центром уведомлений с помощью [портал Azure].  Запишите имя центра уведомлений (его можно найти с помощью параметров приложения).
