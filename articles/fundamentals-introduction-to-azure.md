...
## <a name="the-components-of-azure"></a>Компоненты Azure
...
Веб-интерфейс Azure называется [порталом управления](http://manage.windowsazure.com). Он позволяет администраторам получать доступ к большинству функций Azure (но не ко всем) и управлять ими.  Обычно перед прекращением действия портала Майкрософт выпускает бета-версию нового портала пользовательского интерфейса. Более новый портал называется [портал предварительной версии Azure](https://portal.azure.com/).
...
*Рисунок. Виртуальные машины Azure предоставляют полный контроль над экземплярами виртуальных машин в облаке.*
 ...
 *Рисунок. Служба веб-приложений Azure выполняет приложение веб-сайта в облаке, не управляя базовым веб-сервером.*
...
*Рисунок. Облачные службы Azure предоставляют возможность запуска высокомасштабируемого пользовательского кода в среде "платформа как услуга" (PaaS)*
...
Поскольку служба Azure со временем выросла, служба очередей хранилища Azure и служба очередей служебной шины предоставляют аналогичные службы очередей. Рекомендации по использованию той или иной службы см. в техническом документе [Очереди Azure и очереди служебной шины: сходства и различия](http://msdn.microsoft.com/library/azure/hh767287.aspx).  В большинстве сценариев можно использовать обе службы.
 ...
 *Рисунок. Разделы служебной шины позволяют одним приложениям публиковать сообщения, а другим — подписываться на сообщения, соответствующие определенным критериям.*
 ...
 *Рисунок. Службы BizTalk предоставляют возможность преобразования форматов XML-сообщений в облаке.*
...
*Рисунок. Планировщик Azure позволяет планировать задания на определенное время и на определенный срок.*
 ...
 **Рисунок. Копии большого двоичного объекта можно кэшировать на сайтах по всему миру.**
 ...
 **Рисунок. HDInsight обеспечивает обработку огромных объемов данных.**
 ...
 **Рисунок. Службы мультимедиа — это платформа для приложений, которые предоставляют клиентам по всему миру видео и мультимедиа.**
...
Чтобы более наглядно ознакомиться с работой служб мультимедиа, скачайте [афишу служб мультимедиа Azure][Azure Media Services Poster].
