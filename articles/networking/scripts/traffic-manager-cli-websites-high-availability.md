...
После выполнения сценария образец hello hello команда может быть группы ресурсов используется tooremove hello, приложение служб приложений и все связанные ресурсы.
...
| [az appservice web create](https://docs.microsoft.com/cli/azure/appservice/web#create) | Создает веб-приложение Azure в течение hello план служб приложений. |
...
Дополнительные образцы сценариев CLI приложения службы можно найти в hello [сеть Azure документации](../cli-samples.md).
