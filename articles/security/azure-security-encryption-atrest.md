...
В Microsoft Azure существует несколько средств для защиты данных в соответствии с требованиями безопасности и соблюдения стандартов в организации. В этой статье подробно описывается защита данных при хранении в Microsoft Azure, а также рассматриваются различные компоненты, непосредственно участвующие в реализации защиты данных, преимущества и недостатки различных основных подходов к защите управления. 
