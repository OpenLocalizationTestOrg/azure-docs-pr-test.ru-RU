...
В этой статье рассматривается использование служб отчетов и технологий Azure для защиты конфиденциальности персональных данных.
...
Компания использует Microsoft Azure для обработки и хранения корпоративных данных. Сюда входят персональные данные, позволяющие установить личность, например имена, адреса, номера телефонов и данные кредитной карты в глобальной клиентской базе. Он также включает традиционные информацию о персонале, например адреса, номера телефонов, идентификационные номера налога и медицинские сведения о сотрудниках компании во всех расположениях. Круизная компания также содержит большую базу данных участников программ лояльности и программ скидок, которая, в свою очередь, содержит персональные данные, позволяющие отслеживать связи с текущими и бывшими клиентами.
...
Компании должны защищать конфиденциальность личных данных сотрудников и клиентов через стратегии безопасности многоуровневый использует управления Azure и средства безопасности для наложения строго контролировать доступ к и обработку личных данных, который должен иметь возможность продемонстрировать его защитные меры для внутренних и внешних аудиторов.
...
Вы можете получить доступ к Log Analytics через портал OMS или Azure, а также любой браузер. Служба Log Analytics поддерживает язык запросов для быстрого получения и консолидации данных в репозитории. Вы можете создать и сохранить поиск по журналам для анализа данных на портале напрямую.
...
2. Выберите **Создать**, а затем укажите имя рабочей области OMS. Выберите подписку, группу ресурсов, расположение и ценовую категорию.
