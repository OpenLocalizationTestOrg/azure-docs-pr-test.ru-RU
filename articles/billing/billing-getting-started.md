...
Если ваша подписка предоставлена на условиях соглашения Enterprise (EA), вы являетесь поставщиком облачных решений (CSP) или участником спонсорского предложения Azure, то многие функции, описываемые в этой статье, вам недоступны. Для вас доступен другой набор инструментов, который можно использовать для управления затратами. Ознакомьтесь с разделом [Дополнительные ресурсы для клиентов с соглашением Enterprise (EA), поставщиков облачных решений (CSP) и участников спонсорского предложения Azure](#other-offers).

Если ваша подписка использует бесплатную пробную версию, [Visual Studio](https://azure.microsoft.com/pricing/member-offers/msdn-benefits-details/), Azure с открытой лицензией (AIO) или BizSpark, то во избежание неожиданной деактивации подписки вам следует знать свою [предельную сумму расходов](#spending-limit). 
...
Для каждой подписки существуют ограничения по умолчанию на такие ресурсы, как число ядер ЦП и количество IP-адресов. Следует учитывать эти ограничения. Дополнительные сведения см. в статье [Подписка Azure, границы, квоты и ограничения службы](../azure-subscription-service-limits.md). Можно [обратиться в службу поддержки](https://portal.azure.com/?#blade/Microsoft_Azure_Support/HelpAndSupportBlade) с просьбой увеличить лимит или квоту.
