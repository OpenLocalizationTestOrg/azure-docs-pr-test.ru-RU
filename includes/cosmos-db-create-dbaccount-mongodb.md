...
3. В hello **новой учетной записи** колонки, укажите нужную конфигурацию hello hello Azure Cosmos DB учетной записи. 
    ...
    В этом кратком руководстве мы будем программирование hello MongoDB API, вам нужно будет выбрать **MongoDB** после заполнения формы hello. Но при наличии данных графа для приложения в социальных сетях, данных документа из приложения каталога, данных таблицы или данных типа "ключ — значение", учтите, что Azure Cosmos DB может предоставить высокодоступную глобально распределенную платформу службы базы данных для всех критически важных приложений.

    Заполните hello **новой учетной записи** колонки, руководствуясь hello сведения в таблице hello.
    ...
    API|MongoDB|Мы будем программировании hello [MongoDB API](../articles/documentdb/documentdb-protocol-mongodb.md) далее в этой статье.|
