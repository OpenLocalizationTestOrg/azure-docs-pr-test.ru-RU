...
3. В колонке **Новая учетная запись** укажите желаемую конфигурацию учетной записи Azure Cosmos DB. 
    ...
    API|Таблица (ключ — значение)|Мы будем программировать [API таблицы](../articles/cosmos-db/table-introduction.md) далее в этой статье.|
