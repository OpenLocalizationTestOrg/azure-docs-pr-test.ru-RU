...
<sup>1</sup> Для всех типов транзакций предусмотрено ограничение в подписке (5 на одно хранилище ключей). Например, аппаратный модуль безопасности — другие транзакции для каждой подписки являются ограниченные too5000 в течение 10 секунд на подписку.
