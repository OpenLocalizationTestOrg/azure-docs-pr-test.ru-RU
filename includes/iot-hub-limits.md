Hello следующей таблице перечислены ограничения hello, связанные с hello разных уровнях (S1, S2, S3, F1). Сведения о стоимости hello каждого *единицы* на каждом уровне. в разделе [цены концентратора IoT](https://azure.microsoft.com/pricing/details/iot-hub/).
...
Hello следующей таблице перечислены hello ограничениях, применяемых ресурсы tooIoT концентратора.
...
| Максимальное число доставок для сообщений обратной связи  <br/> в ответном сообщении облака на устройство tooa |100 |
| Максимальный срок жизни для сообщений обратной связи  <br/> облака на устройство tooa ответного сообщения |2 дня |
...
> [!NOTE]
> В настоящее время hello максимальное число устройств, можно подключить один центр IoT tooa составляет 500 000. Если вы хотите tooincrease этот предел, обратитесь в службу [поддержки Майкрософт](https://azure.microsoft.com/en-us/support/options/).

Служба центра IoT Hello регулирует запросы при превышении следующих квот hello:
...
| Прямые методы | 3000 в секунду на единицу (для S3), 60 в секунду на единицу (S2), 20 в секунду на единицу (для S1) |
