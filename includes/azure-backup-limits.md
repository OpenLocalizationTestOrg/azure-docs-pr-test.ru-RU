Hello следующие ограничения применяются tooAzure резервного копирования.
...
| Диски с данными присоединенного tooan виртуальной машины Azure для резервного копирования |16 |

* <sup>1</sup>54400 ГБ hello не применить резервную копию виртуальной Машины tooIaaS.
