Hello следующей таблице перечислены квоты и ограничивает конкретных tooAzure концентраторов событий. См. сведения о [ценах на концентраторы событий](https://azure.microsoft.com/pricing/details/event-hubs/).
