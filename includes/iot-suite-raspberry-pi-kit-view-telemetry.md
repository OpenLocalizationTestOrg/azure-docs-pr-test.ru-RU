...
- Выберите **InvokeMethod**. Hello Индикатор подключен toohello, Raspberry Pi мигает несколько раз. приложение Hello на hello Raspberry Pi отправляет подтверждение задней toohello решений мониторинга:
