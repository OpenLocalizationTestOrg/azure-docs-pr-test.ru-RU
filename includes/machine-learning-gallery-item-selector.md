<span data-ttu-id="47f04-101">**[Cortana Intelligence Gallery](http://gallery.cortanaintelligence.com)** — это управляемый сообществом сайт для поиска и обмена решениями, созданными с помощью Cortana Intelligence Suite.</span><span class="sxs-lookup"><span data-stu-id="47f04-101">**[Cortana Intelligence Gallery](http://gallery.cortanaintelligence.com)** is a community-driven site for discovering and sharing solutions built with Cortana Intelligence Suite.</span></span>
<span data-ttu-id="47f04-102">Hello коллекции имеет множество ресурсов, которые можно использовать toodevelop собственные решения для аналитики.</span><span class="sxs-lookup"><span data-stu-id="47f04-102">hello Gallery has a variety of resources that you can use toodevelop your own analytics solutions.</span></span>
