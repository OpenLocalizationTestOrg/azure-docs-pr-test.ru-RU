Существуют некоторые ограничения на количество hello метрики и события каждого приложения (то есть на ключ инструментирования). Ограничения зависят от hello [ценовой план](https://azure.microsoft.com/pricing/details/application-insights/) выбранный.
...
| Регулирование | 32 000 событий в секунду | предел Hello измеряется в течение одной минуты.
